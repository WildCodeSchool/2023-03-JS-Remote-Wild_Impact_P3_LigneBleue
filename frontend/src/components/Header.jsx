...
function Header() {
  return (
    <div className=" bg-yellow h-28 pt-2">
      ...
      <div>
        <h1 className="text-2xl font-bold mt-6 pl-4 text-blue">LA LIGNE BLEUE</h1>
        <h6 className="text-xs pr-8">Rendre visibles les invisibles du numérique</h6>
      </div>
    </div>
    <hr className="border-t-2 border-blue mr-6 ml-6"/>
    </div>
  );
}
